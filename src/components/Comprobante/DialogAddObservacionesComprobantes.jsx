...
export const DialogAddObservacionesComprobantes = ({
  handleClickObservacionesComprobantes,
}) => {
  ...
  const handleAceptar = () => {
    ...
    handleClickObservacionesComprobantes(observacion);
    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            El proceso de este tramite, quedara retenido debido a la observacion que se ha enviado , por favor verificar al supervisor para que revise el tramite y proceda a liberarlo.  
            <br />
...
DialogAddObservacionesComprobantes.propTypes = {
  handleClickObservacionesComprobantes: PropTypes.func,
};
