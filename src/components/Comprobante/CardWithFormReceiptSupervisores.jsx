...
import { searchComprobanteRequestSupervisores } from "@/services/comprobantes";
import { DataTableReceiptSupervisores } from "./DataTableReceiptSupervisores";

export const CardWithFormReceiptSupervisores = () => {
  ...
  const handleBuscar = async (event) => {
    ...
    const responseReceipt = await searchComprobanteRequestSupervisores(requestComprobante,token)
  ...
  return (
    <Card className="w-full px-4 md:px-8">
      <CardHeader>
        ...
        <CardDescription>
          En esta opción podra consultar los comprobantes de la banca virtual.
        </CardDescription>
      ...
      <CardContent className="overflow-x-auto">
        <DataTableReceiptSupervisores data={dataReceipt} />
      </CardContent>
    </Card>
  );
};
