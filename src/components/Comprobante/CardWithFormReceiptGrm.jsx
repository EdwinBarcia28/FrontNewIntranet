...
export const CardWithFormReceiptGrm = () => {
  ...
  return (
    <Card className="w-full px-4 md:px-10 max-w-[1400px] mx-auto">
      <CardHeader>
        <CardTitle>Consulta de Comprobantes Registrados </CardTitle>
        <CardDescription>
          En esta opción podra consultar los comprobantes Registrados por los distintos operadores en todas las oficinas.
        </CardDescription>
      ...
      <CardContent className="overflow-x-auto">
        <DataTableReceiptGrm data={dataReceiptBandeja} onRefresh={refreshDocument} />
      </CardContent>
    </Card>
  );
};
