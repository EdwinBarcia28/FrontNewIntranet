...
import { DataTableReceiptEdicion } from "./DataTableReceiptEdicion";

export const CardWithFormReceiptEdicion = () => {
  ...
  return (
    <Card className="w-full px-4 md:px-10 max-w-[1400px] mx-auto">
      <CardHeader>
        <CardTitle>Editar Comprobantes</CardTitle>
        <CardDescription>
          En esta opción podra consultar los comprobantes Registrados y editarlos o anularlos por los distintos operadores en todas las oficinas.
        </CardDescription>
      ...
      <CardContent className="overflow-x-auto">
        <DataTableReceiptEdicion data={dataReceiptBandeja} onRefresh={refreshDocument} />
      </CardContent>
    </Card>
  );
};
