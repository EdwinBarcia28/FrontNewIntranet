...
export const DialogAcceptReceiptRegistration = ({ onAccept , loadingReceipt }) => {
  ...
  return (
    <AlertDialog>
      <AlertDialogTrigger asChild>
        {loadingReceipt ? (
            <Button onClick={onAccept} disabled={loadingReceipt}>
            {isMobile ? (
              <TooltipProvider>
                <Tooltip>
              ...
              <>
                <Loader className="animate-spin" /> Guardar Comprobante
              </>
            )}
          </Button>
        ) : (
