...
export const DialogAddObservacionesCertificado = ({
  handleClickObservacionesCertificado,
}) => {
  ...
  const handleAceptar = () => {
    ...
    handleClickObservacionesCertificado(observacion);
...
DialogAddObservacionesCertificado.propTypes = {
